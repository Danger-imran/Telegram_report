...
Ya_Bs = '\033[1;34m'
S_aBs = '\033[1;33m'
ab = pyfiglet.figlet_format("AX TG REPORT")
print(a_bSa+ab)
def to(s):
    for char in s + "\n":
...
to(
    f"\033[31;m TOOL >> \033[1;36mTELEGRAM REPORT SCRIPT\n\033[1;31m DEVELOPER >>\033[1;33m @mr_danger_x \n\033[31;m JOIN >> \033[1;36m https://t.me/we_are_haker  \n")
def R(m,email,num):
